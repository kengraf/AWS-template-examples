...
Sharable JSON templates can be generated by launching a template then using the following command to retrieve the data.  
```
aws ec2 get-launch-template-data --instance-id <the-new-instance-id>
```
